...
with col1:
    st.write("Ebene 1")
    eingabe_e1_n = st.text_input("Normalenvektor für Ebene 1")
    eingabe_e1_p = st.text_input("Punkte auf $E_1$")
with col2:
    st.write("Ebene 2")
    eingabe_e2_n = st.text_input("Normalenvektor für Ebene 2")
    eingabe_e2_p = st.text_input("Punkte auf $E_2$")
try:
